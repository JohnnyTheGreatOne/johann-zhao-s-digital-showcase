...
const achievements = {
  en: [
    { year: "2026", title: "Prize Winner — International Summer Academy of the Mozarteum", detail: "Honored at the closing concert of the International Summer Academy of the Mozarteum 2026" },
